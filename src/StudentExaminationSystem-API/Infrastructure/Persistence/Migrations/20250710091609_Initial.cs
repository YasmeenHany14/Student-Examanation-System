        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GeneratedExams_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GeneratedExams_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubjectExamConfigs", x => x.SubjectId);
                    table.ForeignKey(
                        name: "FK_SubjectExamConfigs_DifficultyProfiles_DifficultyProfileId",
                        column: x => x.DifficultyProfileId,
                        principalTable: "DifficultyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubjectExamConfigs_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnswerHistories", x => new { x.GeneratedExamId, x.QuestionId });
                    table.ForeignKey(
                        name: "FK_AnswerHistories_QuestionChoices_QuestionChoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerHistories_QuestionChoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GeneratedExams_StudentId_SubjectId",
                table: "GeneratedExams",
                columns: new[] { "StudentId", "SubjectId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GeneratedExams_SubjectId",
                table: "GeneratedExams",
                column: "SubjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubjectExamConfigs_DifficultyProfileId",
